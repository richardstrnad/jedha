...
class TestCDPEntryClass(unittest.TestCase):
    def test_get_all_properties_nxos(self):
        ...
        self.assertEqual(device.cdp_entries[0].platform, 'cisco WS-C3560-48PS')
    ...
    def test_get_all_properties_ios(self):
        ...
        self.assertEqual(device.cdp_entries[0].platform, 'cisco AIR-LAP1131G-E-K9')
    ...
    def test_ciscocmd_input_line_split(self):
        ...
        for dev in devices:
            if dev.hostname == '192.168.255.1':
                ...
                self.assertEqual(dev.cdp_entries[-1].platform, 'cisco AIR-LAP1142N-E-K9')
